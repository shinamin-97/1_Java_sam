...
public class ArrayExample {
	...
	public void ex6() {
		...
		String[] menuArr = {"김밥+라면", "KFC", "맘스터치", "서브웨이", "백반", "순대국"	};
	...
	public void ex7() {
		...
		// for문에 break ponit를 지정하면 증감식이 해석되기 전에 멈춘다! (debug mode)
...
//		System.arraycopy(arr, 0, copyArr, 0, arr.length);
	...
	public void ex11() {
		...
		// arr1 == null -> false == arr1 참조 변수가 무언가를 참조하고있다.
