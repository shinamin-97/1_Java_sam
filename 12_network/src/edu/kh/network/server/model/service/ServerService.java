...
//		1) 서버의 포트번호 정함
		...
		// (단, 1023번 이하는 이미 사용 중인 경우가 많으니 피하는게 좋다.)
		...
		// 4) 접속 요청이 오면 요청 수락 후 해당 클라이언트에 대한 소켓 객체 생성
			...
			// -> 클라이언트의 요청이 오고 수락이 될 떄 까지 무한 대기
		...
		Date now = new Date(); // java.util.Date : 자방[서 시간을 나타내는 객체
		...
		// 클라이언트 메세지 출력
		System.out.println(clientIP + "가 보낸 메세지 : " + clientMessge);						
