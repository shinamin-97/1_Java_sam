...
import edu.kh.poly.ex2.model.vo.SAMCalculator;
...
//		f1.breath();
		...
		// arr[i] 인텍스에 어떤 Animal 자식 객체가 있는지 모르지만
	...
	public void ex2() {
		...
		// 인터페이스는 미완성 메소드로만 이루어져 있어서 직접 객체 생성 불가
		// KH k1 = new KH();
	...
	public void ex3() {
		...
		Calculator cal = new SAMCalculator();
	...
	System.out.print("결과 : " + cal.pow(a, b));
