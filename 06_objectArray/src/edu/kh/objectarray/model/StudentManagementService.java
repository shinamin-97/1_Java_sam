...
public class StudentManagementService {
	...
	public StudentManagementService() {
		...
		stdArr[1] = new Student(2, 3, 15, "신기천", 80, 40, 50);
		stdArr[2] = new Student(5, 1, 10, "정성헌", 90, 30, 90);
		stdArr[3] = new Student(6, 2, 9, "신용욱", 50, 50, 10);
	}
	...
	public int addStudent(int grade, int classRoom, int number, String name) {
		...
		// 배열에 요소 중 아무것도 참조하지 않는 (null) 인덱스 찾기
	...
	public String selectIndex(int idx) {
		...
		}else { // 범위 초과 시 X, null X -> 학생 정보 존재
